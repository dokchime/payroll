<nav class="navbar navbar-expand-lg navbar-dark bg-success text-white">
    <div class="container-fluid">
        <a class="navbar-brand" href="../views/dashboard.php">
            <img src="../includes/images/logo.png" alt="" width="60" height="40" class="d-inline-block align-text-top">
            Payroll Taraba State
        </a>
        ...
        <a href="../session/logout.php" class="nav-link btn btn-danger text-white">Logout</a>
        </ul>
    </div>
    </div>
</nav>