<?php
require_once "../controllers/GradeBasedDeductions.php";

$deduction = new GradeBasedDeductions();
...
switch ($action) {
    ...
    case 'read':
        if (isset($_GET['id'])) {
            ...
            $totalDeductions = $deduction->getCounts();
    ...
    case 'delete':
        $id = $data['id'];
        $success = $deduction->deleteDeduction($id);
        echo json_encode(['success' => $success]);
        break;
