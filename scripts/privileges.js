...
$(document).ready(function () {
        ...
        if (response.status === "success") {
          ...
          privileges.forEach(function (privilege) {
            html += `<tr>
                                ...
                                <td><button class="edit btn btn-warning" data-id="${privilege.categ_id}">Edit</button></td>
                                </tr>`;
          });
  ...
  $(document).on("click", ".edit", function () {
    ...
    $.post(
      url,
      { action: "get_privilege_by_id", categ_id: categ_id },
      function (response) {
        if (response.status === "success") {
  ...
  $(document).on("click", ".delete", function () {
    ...
    if (confirm("Are you sure you want to delete this privilege?")) {
      $.post(
        url,
        { action: "delete_privilege", categ_id: categ_id },
        function (response) {
          if (response.status === "success") {
