    ...
    <div class="container">
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-6">
                <div class="auth-form p-5">
                    <div class="bg-success p-3 mb-2 text-white">
                        <h4 class="text-center font-bold">Create Individual Addition</h4>
                    </div>
            ...
            <div class="col-md-6">
                <div class="auth-form p-5">
                    <div class="bg-success p-3 mb-2 text-white">
                        <h4 class="m-2 text-center font-bold">Upload Individual Additions CSV</h4>
                    </div>
                    <form id="csvUploadForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <a href="../sample_csv/individual_based_additions_sample.csv" download="individual_based_additions_sample.csv" class="text-success">Download Sample CSV</a>
                        </div>
        ...
        <div class="mt-5">
            <div class="bg-success p-3">
                <h4 class="text-center text-white"> <i> INDIVIDUAL BASED ADDITIONS </i></h4>
            </div>
