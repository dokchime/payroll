    ...
    <div class="container">
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-6">
                <div class="auth-form p-5">
                    ...
                    <form id="deductionForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="salary_structure_grade" class="form-label">Salary Structure Grade</label>
                            <select class="form-control" id="salary_structure_grade" name="salary_structure_grade" required>
            ...
            <div class="col-md-6">
                <div class="auth-form p-5">
                    <div class="bg-success p-3 mb-2 text-white">
                        <h4 class="m-2 text-center font-bold">Upload Deduction CSV</h4>
                    </div>
