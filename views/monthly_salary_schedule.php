...
<head>
    ...
    <script src="../scripts/monthly_salary_schedule.js" defer></script>
</head>
            ...
            <div class="col-md-6">
                <div class="auth-form p-5">
                    ...
                    <form id="salaryScheduleForm" enctype="multipart/form-data" method="POST" action="process_salary_schedule.php">
                        ...
                        <div class="mb-3">
                            <label for="salary_structure_grades_id" class="form-label">Salary Structure Details</label>
            ...
            <div class="col-md-6">
                <div class="auth-form p-5">
                    ...
                    <form id="csvUploadForm" enctype="multipart/form-data" method="POST" action="upload_salary_schedule.php">
                        ...
                        <div class="mb-3">
                            <a href="../sample_csv/monthly_salary_schedule_sample.csv" download="monthly_salary_schedule_sample.csv" class="text-success">Download Sample CSV</a>
                        </div>
